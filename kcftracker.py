...
def rearrange(img):
	...
	xh2, yh2 = (img.shape[1]+1)//2, (img.shape[0]+1)//2
	img_[0:yh,0:xh], img_[yh2:img.shape[0],xh2:img.shape[1]] = img[yh2:img.shape[0],xh2:img.shape[1]], img[0:yh,0:xh]
	img_[0:yh,xh2:img.shape[1]], img_[yh2:img.shape[0],0:xh] = img[yh2:img.shape[0],0:xh], img[0:yh,xh2:img.shape[1]]
	return img_
