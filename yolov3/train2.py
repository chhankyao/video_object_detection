...
last = wdir + 'last_retrain.pt'
best = wdir + 'best_retrain.pt'
results_file = 'results_retrain.txt'
...
hyp = {'giou': 1.582,  # giou loss gain
       ...
       'lr0': 9e-5, #0.002324*0.1,  # initial learning rate (SGD=1E-3, Adam=9E-5)
